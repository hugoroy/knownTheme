...
<form id="bgform" action="<?= \Idno\Core\site()->config()->getDisplayURL() ?>admin/hugoroy/" method="post"
    ...
    <div class="row">
        ...
        <div class="span6 offset3">
            ...
            <p>
                <img src="<?= \Themes\Hugoroy\Controller::getBackgroundImageURL() ?>"
            ...
            <p>
                <?= \Idno\Core\site()->actions()->signForm(\Idno\Core\site()->config()->getDisplayURL() . 'admin/hugoroy/') ?>
                            ...
                            foreach ($vars['users'] as $user) {
                                ...
                                <option value="<?= $user->handle ?>" <?php
                                    ...
                                    if (!empty(\Idno\Core\site()->config->hugoroy['profile_user'])) {
                                        if ($user->handle == \Idno\Core\site()->config->hugoroy['profile_user']) {
                                            echo 'selected';
                                        }
                                    }
